...
exports.wrapDustOnLoad = function (ext, dustjs, config, needCache, app) {
    var conf = {},
        viewCache,
        i18n = config.i18n;
    ...
    dustjs.onLoad = function spclOnLoad(name, context, cb) {
        var specialization = (typeof context.get === 'function' && context.get('_specialization')) || context._specialization;
